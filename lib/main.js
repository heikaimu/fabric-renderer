 ...
 * @LastEditTime: 2022-11-24 17:26:09
 * @FilePath: /fabric-renderer-js/lib/main.js
 */
import Renderer, { fabric, CalendarMatrix } from './index';
...
document.getElementById('calendar').addEventListener('click', () => {
  // Lobster Satisfy Pacifico
  const font = new FontFaceObserver('Satisfy');
  const heart = 'https://cdn.shopify.com/s/files/1/0343/0275/4948/files/heart_91c85e27-f413-402e-b7ab-3689126b76d6.png?v=1669274964';
  const cake = 'https://cdn.shopify.com/s/files/1/0343/0275/4948/files/cake.png?v=1669276159';

  const calendar = new CalendarMatrix({
    icon: heart,
    color: '#ffffff',
    fontFamily: 'Satisfy',
  })
  font.load().then(() => {
    calendar.render().then(res => {
      console.log(res)
    });
  })
})
